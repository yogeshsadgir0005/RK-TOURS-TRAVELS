    ...
    <PageTransition>
      <div className="min-h-screen bg-bg-secondary pb-24 pt-32 px-4 sm:px-8 font-sans">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-12 lg:items-start">
          ...
          <div>
            <div className="mb-12">
              <h1 className="text-4xl font-extrabold text-black tracking-tight mb-2">Complete your booking</h1>
              <p className="text-gray-500 font-medium">Almost there. Please provide your travel details.</p>
            </div>

            <form onSubmit={handleSubmit} className="space-y-8">
              
              {/* Section 1: Passenger */}
              <div className="bg-white p-8 rounded-[32px] border border-gray-100 shadow-saas-sm">
                <div className="flex items-center gap-4 mb-8">
                  <div className="w-8 h-8 rounded-full bg-black text-white flex items-center justify-center text-sm font-bold">1</div>
                  <h2 className="text-xl font-bold text-black tracking-tight">Passenger Details</h2>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input type="text" required value={passengerName} onChange={(e) => setPassengerName(e.target.value)} className="w-full h-12 pl-11 pr-4 bg-gray-50/50 border border-gray-200 rounded-xl text-sm font-semibold text-black focus:border-black focus:bg-white shadow-saas-inner outline-none transition-colors" />
                    </div>
                  </div>
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input type="tel" required value={passengerPhone} onChange={(e) => setPassengerPhone(e.target.value)} placeholder="10-digit mobile number" className="w-full h-12 pl-11 pr-4 bg-gray-50/50 border border-gray-200 rounded-xl text-sm font-semibold text-black focus:border-black focus:bg-white shadow-saas-inner outline-none transition-colors" />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white p-8 rounded-[32px] border border-gray-100 shadow-saas-sm">
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <h2 className="text-xl font-bold text-black tracking-tight">Pickup & Drop Addresses</h2>
                </div>
                
                <div className="space-y-6">
                  <div className="border border-gray-200 rounded-2xl p-4 sm:p-6 relative">
                    <div className="absolute top-6 left-6 w-8 h-8 bg-black rounded-full flex items-center justify-center">
                       <div className="w-2 h-2 bg-white rounded-full"></div>
                    </div>
                    <div className="ml-12">
                      <h3 className="text-sm font-bold text-black mb-4">Pickup Address</h3>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="md:col-span-2">
                          ...
                          <input type="text" required value={pickupStreet} onChange={(e) => setPickupStreet(e.target.value)} placeholder="E.g., Flat 101, Galaxy Apts, MG Road" className="w-full h-12 px-4 bg-gray-50/50 border border-gray-200 rounded-xl text-sm font-semibold text-black focus:border-black focus:bg-white shadow-saas-inner outline-none transition-colors" />
                        </div>
                        <div>
                          <label className="text-[10px] font-bold uppercase tracking-widest text-gray-400 mb-1 block">City</label>
                          <input type="text" required value={pickupCity} onChange={(e) => setPickupCity(e.target.value)} className="w-full h-12 px-4 bg-gray-100 border border-transparent rounded-xl text-sm font-semibold text-black outline-none cursor-not-allowed" readOnly />
                        </div>
                        <div>
                          <label className="text-[10px] font-bold uppercase tracking-widest text-gray-400 mb-1 block">State</label>
                          <input type="text" required value={pickupState} onChange={(e) => setPickupState(e.target.value)} className="w-full h-12 px-4 bg-gray-100 border border-transparent rounded-xl text-sm font-semibold text-black outline-none cursor-not-allowed" readOnly />
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="border border-gray-200 rounded-2xl p-4 sm:p-6 relative">
                    <div className="absolute top-6 left-6 w-8 h-8 border-2 border-black rounded-full flex items-center justify-center">
                       <div className="w-2 h-2 bg-black rounded-full"></div>
                    </div>
                    <div className="ml-12">
                      <h3 className="text-sm font-bold text-black mb-4">Drop Address</h3>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="md:col-span-2">
                          <label className="text-[10px] font-bold uppercase tracking-widest text-gray-400 mb-1 block">Street / Area / Landmark</label>
                          <input type="text" required value={dropStreet} onChange={(e) => setDropStreet(e.target.value)} placeholder="E.g., Airport Terminal 2" className="w-full h-12 px-4 bg-gray-50/50 border border-gray-200 rounded-xl text-sm font-semibold text-black focus:border-black focus:bg-white shadow-saas-inner outline-none transition-colors" />
                        </div>
                        <div>
                          <label className="text-[10px] font-bold uppercase tracking-widest text-gray-400 mb-1 block">City</label>
                          <input type="text" required value={dropCity} onChange={(e) => setDropCity(e.target.value)} className="w-full h-12 px-4 bg-gray-100 border border-transparent rounded-xl text-sm font-semibold text-black outline-none cursor-not-allowed" readOnly />
                        </div>
                        <div>
                          <label className="text-[10px] font-bold uppercase tracking-widest text-gray-400 mb-1 block">State</label>
                          <input type="text" required value={dropState} onChange={(e) => setDropState(e.target.value)} className="w-full h-12 px-4 bg-gray-100 border border-transparent rounded-xl text-sm font-semibold text-black outline-none cursor-not-allowed" readOnly />
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div className="lg:sticky lg:top-32 w-full">
            <div className="bg-white rounded-[32px] border border-gray-200 shadow-saas-lg p-6 sm:p-8">
              
              {/* Mini Map */}
              <div className="w-full h-[180px] bg-gray-100 rounded-2xl mb-6 border border-gray-200 overflow-hidden shadow-saas-inner">
              ...
              {/* Cab Details */}
              <div className="flex items-center gap-4 mb-8">
                <div className="w-16 h-12 bg-gray-50 rounded-lg p-1 border border-gray-100 flex-shrink-0">
                  <img src={cab.image || 'https://via.placeholder.com/400x300?text=Cab'} alt={cab.name} className="w-full h-full object-contain" />
                </div>
                <div>
                  <h4 className="font-extrabold text-black tracking-tight leading-tight">{cab.name}</h4>
                  <p className="text-[10px] font-bold uppercase tracking-widest text-gray-500">{cab.category} • {cab.seats} Seats</p>
                </div>
              </div>

              {/* Receipt Table */}
              <div className="space-y-4 mb-8">
                <h4 className="text-[10px] font-bold uppercase tracking-widest text-gray-400 border-b border-gray-100 pb-2">Fare Breakdown</h4>
                <div className="flex flex-col gap-3 font-mono text-sm">
                  <div className="flex justify-between text-gray-600">
                    <span>Base Fare {customFixedFare ? '(Fixed)' : `(${Math.max(calculatedDistance, 250).toFixed(0)}km min)`}</span>
                    <span className="font-semibold text-black">₹{totalFare}</span>
                  </div>
                  <div className="flex justify-between text-gray-600">
              ...
              <div className="flex items-start gap-3 mb-8 bg-gray-50 p-4 rounded-2xl border border-gray-100">
                ...
                <p className="text-xs text-gray-600 font-medium leading-relaxed">Secure transaction. No hidden charges. Free cancellation up to 24 hours before pickup.</p>
              </div>
